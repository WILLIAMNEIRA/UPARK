...
@Component({
  selector: 'app-anexos-carro',
  templateUrl: './anexos-carro.component.html',
  styleUrls: ['./anexos-carro.component.css']
})
export class AnexosCarroComponent {
  puestos = [
  ...
  puestosList2 = [
    ...
    { name: '39° Puesto', active: true },
    { name: '31° Puesto', active: true },
    { name: '32° Puesto', active: true },
    { name: '33° Puesto', active: true },
    { name: '34° Puesto', active: true },
    { name: '35° Puesto', active: true },
    { name: '36° Puesto', active: true },
