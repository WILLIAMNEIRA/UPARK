...
@Component({
  selector: 'app-laboratorios-carro',
  templateUrl: './laboratorios-carro.component.html',
  styleUrls: ['./laboratorios-carro.component.css']
})
export class LaboratoriosCarroComponent {
  puestos = [
